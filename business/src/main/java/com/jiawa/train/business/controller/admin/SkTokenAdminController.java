...
public class SkTokenAdminController {
    ...
    @PostMapping ("/save")
    public CommonResp<Object> save(@RequestBody @Validated SkTokenSaveReq req){
        skTokenService.save(req);
        return new CommonResp<>();
    }

    @GetMapping ("/query-list")
    public CommonResp<PageResp<SkTokenQueryResp>> queryList(@Validated SkTokenQueryReq req){
