...
public class ConfirmOrderService {
    ...
    public void doConfirm(ConfirmOrderDoReq req){
        ...
        if(StrUtil.isNotBlank(seat)){
            ...
            getSeat(date,trainCode,tickets.get(0).getSeatTypeCode(),seat.split("")[0],offsetList);
        }else {
            LOG.info("本次购票没有选座");
            for(ConfirmOrderTicketReq confirmOrderTicketReq : tickets){
    ...
    public void getSeat(Date date, String trainCode, String seatType, String column, List<Integer> offsetList){
